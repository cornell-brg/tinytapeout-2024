module Ps2_to_Linear(
  ...
  localparam linear_backspace = 6'd37; // this will not be cyphered
  ...
  localparam ps2_space = 8'h29;
  localparam ps2_backspace = 8'h66;
  localparam ps2_enter = 8'h5A;
  ...
  always_comb begin
    case (ps2_value)
      ...
      ps2_9: linear_value = linear_9;
		ps2_space: linear_value = linear_space;
		ps2_backspace: linear_value = linear_backspace;
		ps2_enter: linear_value = linear_enter;
      default: linear_value = linear_1;
    endcase
  end
