...
localparam WAIT_VDD        = 4'h0;
localparam FUNCTION_SET1   = 4'h1; 
localparam FUNCTION_SET2   = 4'h2; 
localparam FUNCTION_SET3   = 4'h3;
localparam DISPLAY_OFF     = 4'h4;
localparam CLEAR_DISPLAY   = 4'h5;
localparam ENTRY_MODE      = 4'h6;
localparam DISPLAY_ON      = 4'h7;
localparam RECEIVE_DATA    = 4'h8;
...
always_comb begin
  case (current_state)
    ...
    RECEIVE_DATA:
      next_state = RECEIVE_DATA; // Stay in this state after setup
  ...
  if (rst) begin
    ...
    case (current_state)
      ...
      FUNCTION_SET1, FUNCTION_SET2, FUNCTION_SET3: begin
        lcd_display_code <= 8'h3C; // Function set 
      ...
      DISPLAY_ON: begin
        lcd_display_code <= 8'h0C; // Display on, cursor off, blink off
        reg_sel <= 1'b0;
        read_write <= 1'b0;
      end
